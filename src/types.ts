...
type Taggable<T extends Constructor> = T & { readonly Tag?: string };

export type EntityType<E extends Entity = Entity> = Taggable<Constructor<E, []>>;
export type ComponentType<C extends Component = Component> = Taggable<Constructor<C, []> & { readonly Id: number }>;
export type SystemType<S extends System = System> = Taggable<Constructor<S>>;
export type ResourceType<R extends Resource = Resource> = Taggable<Constructor<R>>;
